...
describe('DateRangePicker', () => {
  ...
  beforeEach(async () => {
    ...
    parentGroup = new FormGroup({
      testControl: new FormControl<Date[] | null>(null),
    });
  ...
  it('should update value in the form control when input value changes', () => {
    const testValue = [new Date(2025, 0, 5), new Date(2025, 0, 10)];
  ...
  it('should emit searchChanged on input with debounce', fakeAsync(() => {
    ...
    const testValue1 = [new Date(2025, 0, 5), new Date(2025, 0, 10)];
    const testValue2 = [new Date(2025, 0, 11), new Date(2025, 0, 12)];
