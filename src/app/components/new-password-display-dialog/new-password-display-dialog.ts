...
@Component({
  selector: 'app-new-password-display-dialog',
  imports: [Dialog, PasswordInput],
  templateUrl: './new-password-display-dialog.html',
  styleUrl: './new-password-display-dialog.scss',
})
export class NewPasswordDisplayDialog {
  /**
